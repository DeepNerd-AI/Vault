...
craneLib.buildPackage (
  lib.recursiveUpdate commonArgs {
      ...
      if stdenv.hostPlatform.isDarwin then
        ...
        ''
          ...
          (
            ...
            ${lib.getExe envsubst} < "crates/zed/resources/zed.desktop.in" > "$out/share/applications/editor.deepnerd.tech-Nightly.desktop"
            chmod +x "$out/share/applications/editor.deepnerd.tech-Nightly.desktop"
          )
    ...
    meta = {
      ...
      homepage = "https://deepnerd.tech";
      changelog = "https://deepnerd.tech/releases/preview";
