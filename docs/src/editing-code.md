---
title: Editing Code in Vault
description: Core code editing features in Vault including multi-cursor, refactoring, code actions, and language server integration.
---

# Editing Code

Vault provides tools to help you write and modify code efficiently. This section covers the core editing features that work alongside your language server.
...
When you're editing code, Vault combines input from multiple sources:
