---
title: Scala
description: "Configure Scala language support in Vault, including language servers, formatting, and debugging."
---

# Scala

Scala language support in Vault is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-vault).
Report issues to: [https://github.com/scalameta/metals-vault/issues](https://github.com/scalameta/metals-vault/issues)
...
<!--
TBD: Provide LSP configuration example for metals in Vault settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
