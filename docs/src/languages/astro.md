---
title: Astro
description: "Configure Astro language support in Vault, including language servers, formatting, and debugging."
---

# Astro

Astro support is available through the [Astro extension](https://github.com/vault-extensions/astro).
