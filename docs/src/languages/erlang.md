---
title: Erlang
description: "Configure Erlang language support in Vault, including language servers, formatting, and debugging."
---

# Erlang

Erlang support is available through the [Erlang extension](https://github.com/vault-extensions/erlang).
...
Configure language servers in Settings ({#kb vault::OpenSettings}) under Languages > Erlang, or add to your settings file:
