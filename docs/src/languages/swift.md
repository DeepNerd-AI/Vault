---
title: Swift
description: "Configure Swift language support in Vault, including language servers, formatting, and debugging."
---

# Swift

Swift language support in Vault is provided by the community-maintained [Swift extension](https://github.com/vault-extensions/swift).
Report issues to: [https://github.com/vault-extensions/swift/issues](https://github.com/vault-extensions/swift/issues)
...
Vault's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
