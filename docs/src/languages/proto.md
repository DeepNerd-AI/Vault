---
title: Proto
description: "Configure Proto language support in Vault, including language servers, formatting, and debugging."
---

# Proto

Proto/proto3 (Protocol Buffers definition language) support is available through the [Proto extension](https://github.com/DeepNerd-AI/vault/tree/main/extensions/proto).
...
Or you can have vault directly invoke `clang-format` by specifying it as a [formatter](https://deepnerd.tech/docs/reference/all-settings#formatter) in your settings:
