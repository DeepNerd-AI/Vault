---
title: Vue
description: "Configure Vue language support in Vault, including language servers, formatting, and debugging."
---

# Vue

Vue support is available through the [Vue extension](https://github.com/vault-extensions/vue).
...
`yarn dlx @yarnpkg/sdks`. In that case, you can provide the following initialization options in your Vault settings:
