---
title: Rego
description: "Configure Rego language support in Vault, including language servers, formatting, and debugging."
---

# Rego

Rego language support in Vault is provided by the community-maintained [Rego extension](https://github.com/StyraInc/vault-rego).
