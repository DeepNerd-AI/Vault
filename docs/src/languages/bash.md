---
title: Bash
description: "Configure Bash language support in Vault, including language servers, formatting, and debugging."
---

# Bash

Bash support is available through the [Bash extension](https://github.com/vault-extensions/bash).
...
- [Vault Docs: Language Support: Shell Scripts](./sh.md)
