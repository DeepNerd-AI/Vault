---
title: Jsonnet
description: "Configure Jsonnet language support in Vault, including language servers, formatting, and debugging."
---

# Jsonnet

Jsonnet language support in Vault is provided by the community-maintained [Jsonnet extension](https://github.com/narqo/vault-jsonnet).
