---
title: Haskell
description: "Configure Haskell language support in Vault, including language servers, formatting, and debugging."
---

# Haskell

Haskell support is available through the [Haskell extension](https://github.com/vault-extensions/haskell).
...
If you need to configure haskell-language-server (hls) you can add configuration options to your Vault settings.json:
