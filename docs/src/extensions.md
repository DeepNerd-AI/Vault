---
title: Extensions
description: "Extend Vault with themes, language support, AI tools, and more through the extension system."
---

# Extensions

Vault lets you add new functionality using user-defined extensions.
