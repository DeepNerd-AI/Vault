---
title: Project Panel - Vault
description: Navigate workspace files and directories with Vault's project panel. Create, rename, trash and delete file and directories.
---
...
![Project Panel](https://images.deepnerd.tech/docs/project-panel/panel.png)
...
![Project Panel: Sticky Scroll Enabled](https://images.deepnerd.tech/docs/project-panel/sticky-scroll-true.png)

![Project Panel: Sticky Scroll Disabled](https://images.deepnerd.tech/docs/project-panel/sticky-scroll-false.png)
...
![Project Panel: Auto Fold Directories Enabled](https://images.deepnerd.tech/docs/project-panel/auto-fold-dirs-true.png)

![Project Panel: Auto Fold Directories Disabled](https://images.deepnerd.tech/docs/project-panel/auto-fold-dirs-false.png)
...
![Project Panel: Compare Marked Files](https://images.deepnerd.tech/docs/project-panel/compare-marked-files.png)
...
When pasting would create a name conflict, Vault appends a "copy" suffix (e.g.,
...
![Project Panel: Git Integration](https://images.deepnerd.tech/docs/project-panel/git-status.png)
