---
title: Run and Test Code in Vault
description: Run and test code in Vault with Terminal, Tasks, REPL, and debugger workflows without leaving the editor.
---

# Running & Testing

Use this section to run and test code in Vault, then debug issues without
leaving the editor.

## What's here

- **[Terminal](./terminal.md)**: Vault's built-in terminal emulator. Open multiple terminals, customize your shell, and integrate with the editor. Tasks and commands run here.
...
- **[Debugger](./debugger.md)**: Set breakpoints, step through code, and inspect variables using Vault's built-in debugger. Works with C, C++, Go, JavaScript, Python, Rust, TypeScript, and more through the Debug Adapter Protocol.
