...
description: "Debugger Extensions for Vault extensions."
---
...
Vault offers an automatic way to create debug scenarios with _debug locators_.
...
See DAP servers published as extensions [on Vault's site](https://deepnerd.tech/extensions?filter=debug-adapters).
