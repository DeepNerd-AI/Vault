...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Vault Dev",
            ReleaseChannel::Nightly => "Vault Nightly",
            ReleaseChannel::Preview => "Vault Preview",
            ReleaseChannel::Stable => "Vault",
        }
    }
    ...
    /// and WM_CLASS on X11.
    /// This also has to match the bundle identifier for Vault on macOS.
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "editor.deepnerd.tech-Dev",
            ReleaseChannel::Nightly => "editor.deepnerd.tech-Nightly",
            ReleaseChannel::Preview => "editor.deepnerd.tech-Preview",
            ReleaseChannel::Stable => "editor.deepnerd.tech",
        }
    }
