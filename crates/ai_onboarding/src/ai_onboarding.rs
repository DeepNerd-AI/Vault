...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            ...
            .relative()
            .gap_1()
            .child(Headline::new("Welcome to Vault AI"))
            .child(
                Label::new("Sign in to try Vault Pro for 14 days, no credit card required.")
                    .color(Color::Muted)
                    .mb_2(),
            )
            .child(PlanDefinitions.pro_plan())
            .child(
                Button::new("sign_in", "Try Vault Pro for Free")
                    .disabled(signing_in)
                    .full_width()
    ...
    fn render_trial_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to the Vault Pro Trial"))
            .child(
    ...
    fn render_pro_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to Vault Pro"))
            .child(
    ...
    fn render_business_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to Vault Business"))
            .child(
                Label::new("Here's what you get:")
                    .color(Color::Muted)
                    .mb_2(),
    ...
    fn render_student_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to Vault Student"))
            .child(
                Label::new("Here's what you get:")
                    .color(Color::Muted)
                    .mb_2(),
