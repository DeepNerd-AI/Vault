...
pub async fn has_any_configured_ai_key(cx: &mut gpui::AsyncApp) -> bool {
    ai_provider_setup::has_any_configured_ai_key_async(cx).await
}
...
struct Onboarding {
    ...
    ai_provider_setup: Option<Entity<ai_provider_setup::AiProviderSetup>>,
...
impl Onboarding {
    ...
    fn render_page(&mut self, window: &mut Window, cx: &mut Context<Self>) -> AnyElement {
        let ai_provider_setup = self
            .ai_provider_setup
            .get_or_insert_with(|| cx.new(|cx| ai_provider_setup::AiProviderSetup::new(window, cx)))
            .clone();
        ai_provider_setup.into_any_element()
    }
}
...
impl Item for Onboarding {
    ...
    fn clone_on_split(
        ...
        Task::ready(Some(cx.new(|cx| Onboarding {
            ...
            ai_provider_setup: self.ai_provider_setup.clone(),
            scroll_handle: ScrollHandle::new(),
            focus_handle: cx.focus_handle(),
