...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            link_text_hover: black().light().step_12(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            text_accent: black().dark().step_12(),
            ...
            icon_accent: black().dark().step_12(),
            debugger_accent: red().light().step_10(),
            ...
            link_text_hover: black().dark().step_12(),
            version_control_added: ADDED_COLOR,
            version_control_deleted: REMOVED_COLOR,
            version_control_modified: MODIFIED_COLOR,
            version_control_renamed: MODIFIED_COLOR,
